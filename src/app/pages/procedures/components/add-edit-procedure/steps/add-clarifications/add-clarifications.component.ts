...
@Component({
  selector: 'app-add-clarifications',
  templateUrl: './add-clarifications.component.html',
  styleUrl: './add-clarifications.component.scss',
})
export class AddClarificationsComponent {
  formGroup!: FormGroup;
