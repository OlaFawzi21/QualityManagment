...
import { CustomerServiceService } from './../../../../_metronic/layout/core/services/customerService/customerService.service';
import { MessageService } from 'primeng/api';

@Component({
  selector: 'app-general-inquiry',
  templateUrl: './general-inquiry.component.html',
  styleUrl: './general-inquiry.component.scss',
})
export class GeneralInquiryComponent {
  generalInq: any[] = [];
