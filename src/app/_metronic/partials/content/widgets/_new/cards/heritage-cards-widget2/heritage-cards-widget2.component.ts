...
@Component({
  selector: 'app-heritage-cards-widget2',
  templateUrl: './heritage-cards-widget2.component.html',
  styleUrl: './heritage-cards-widget2.component.scss',
})
export class HeritageCardsWidget2Component {
  chartOptions: any = {};
